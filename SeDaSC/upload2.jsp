...
//b1=new Blob(b);
PreparedStatement pst=con.prepareStatement("insert into files(fid,filename,file_,group_,user,status) values(?,?,?,?,?,?)");
pst.setInt(1,randomInt);
pst.setString(2,pname);
pst.setBinaryStream(3,(InputStream)fis,(int)(f.length()));
pst.setString(4,(String)session.getAttribute("group"));
